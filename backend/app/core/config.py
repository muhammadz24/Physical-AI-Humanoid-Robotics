...
class Settings(BaseSettings):
    ...
    ALLOWED_ORIGINS: str = "http://localhost:3000,https://localhost:3000,http://localhost:8000,https://localhost:8000,http://127.0.0.1:3000,https://127.0.0.1:3000,https://physical-ai-humanoid-robotics.vercel.app,*"
